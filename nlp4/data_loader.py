...
if __name__ == '__main__':
    ...
    print(len(get_rare_words_examples(dataset.get_test_set(), dataset)))
    print(get_rare_words_examples(dataset.get_test_set(), dataset))
    print(len(get_negated_polarity_examples(dataset.get_test_set())))
    print(get_negated_polarity_examples(dataset.get_test_set()))
    ...
    #
    # print(len(dataset.get_train_set()))
    # print(len(dataset.get_validation_set()))
    # print(len(dataset.get_test_set()))
    #
    # # print(dataset.get_word_counts())
    # # print(dataset.get_train_word_counts())
    # # print(dataset.get_train_set_phrases())
    # print(dataset.get_train_set_phrases()[:5])
